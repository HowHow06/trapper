...
if (
  ...
  const e =
      'object' == typeof globalThis
        ...
        : this,
    t = e.FormData,
    n = e.XMLHttpRequest && e.XMLHttpRequest.prototype.send,
    o = e.Request && e.fetch,
    a = e.navigator && e.navigator.sendBeacon,
    s = e.Element && e.Element.prototype,
    r = e.Symbol && Symbol.toStringTag;
  r &&
    (Blob.prototype[r] || (Blob.prototype[r] = 'Blob'),
    'File' in e && !File.prototype[r] && (File.prototype[r] = 'File'));
  try {
    new File([], '');
  } catch (t) {
    e.File = function (e, t, n) {
      const o = new Blob(e, n),
        a =
      ...
      return (
        Object.defineProperties(o, {
          name: { value: t },
          lastModifiedDate: { value: a },
          lastModified: { value: +a },
          toString: { value: () => '[object File]' },
        }),
        r && Object.defineProperty(o, r, { value: 'File' }),
        o
      );
    };
  }
  function normalizeValue([e, t, n]) {
    return (
      t instanceof Blob &&
        (t = new File([t], n, { type: t.type, lastModified: t.lastModified })),
      [e, t]
    );
  }
  ...
  function normalizeArgs(e, t, n) {
    return t instanceof Blob
      ? [
          String(e),
          t,
          void 0 !== n ? n + '' : 'string' == typeof t.name ? t.name : 'blob',
        ]
      : [String(e), String(t)];
  }
  ...
  class i {
        ...
        each(e.elements, (e) => {
          if (
            ...
            if ('file' === e.type) {
              ...
              const n =
                'textarea' === e.type ? normalizeLinefeeds(e.value) : e.value;
              t.append(e.name, n);
            }
        });
    }
    append(e, t, n) {
      ensureArgs(arguments, 2), this._data.push(normalizeArgs(e, t, n));
    }
    delete(e) {
    ...
    *entries() {
    ...
    forEach(e, t) {
      ensureArgs(arguments, 1);
      for (const [n, o] of this) e.call(t, o, n, this);
    }
    get(e) {
      ensureArgs(arguments, 1);
      const t = this._data;
      ...
      for (let n = 0; n < t.length; n++)
        if (t[n][0] === e) return normalizeValue(t[n])[1];
      return null;
    }
    getAll(e) {
      ensureArgs(arguments, 1);
    ...
    has(e) {
      ensureArgs(arguments, 1), (e = String(e));
      for (let t = 0; t < this._data.length; t++)
        if (this._data[t][0] === e) return !0;
      return !1;
    }
    *keys() {
    ...
    set(e, t, n) {
      ensureArgs(arguments, 2), (e = String(e));
      const o = [],
    ...
    *values() {
    ...
    _asNative() {
      const e = new t();
      for (const [t, n] of this) e.append(t, n);
      return e;
    }
    _blob() {
  ...
  o &&
    (e.fetch = function (e, t) {
      return (
        t && t.body && t.body instanceof i && (t.body = t.body._blob()),
        o.call(this, e, t)
      );
    }),
    a &&
      (e.navigator.sendBeacon = function (e, t) {
        return t instanceof i && (t = t._asNative()), a.call(this, e, t);
      }),
    (e.FormData = i);
}
...
!(function (t, e, n) {
  function r(t, e, n, r) {
    return c(t, n, r, e).then(function (a) {
      ...
      return v.ready.then(function () {
        ...
        return (
          e.removeContainer &&
            (a.parentNode.removeChild(a), E('Cleaned up container')),
          t
        );
      });
    });
  ...
  function p(t) {
    if (
      ...
      E('Initiating DummyImageContainer'), (p.prototype.image = new Image());
      var e = this.image;
  ...
  function P(t, e, n, r, i) {
    ...
    t !== t.ownerDocument.documentElement &&
      ...
      e.rectangle(
        ...
        e.width,
        e.height,
        new T(t.ownerDocument.documentElement, null).css('backgroundColor')
      ),
  ...
  function ue(r, i) {
    ...
    this.promise = new Promise(function (r, i) {
      (h.image.onload = r),
        (h.image.onerror = i),
        (t[o] = function (e) {
          'error:' === e.substring(0, 6) ? i() : (h.image.src = e), (t[o] = n);
          try {
            delete t[o];
          } catch (r) {}
      ...
      !(function () {
          ...
          function n(t) {
            ...
            return new e(function (e, n) {
              ...
              for (var h = 0; h < t.length; h++)
                (s = t[h]), s && i(s.then) ? s.then(r(h), n) : o(h, s);
            });
          }
          var r = t.isArray,
            i = t.isFunction;
        ...
        n(
          ...
          function (t, e, n, r, i, o, s, a, c) {
            ...
            function m(t, e) {
              t._state === O &&
                ((t._state = B), (t._detail = e), b.async(v, t));
            }
            function y(t, e) {
              t._state === O &&
                ((t._state = B), (t._detail = e), b.async(w, t));
            }
            function v(t) {
              d(t, (t._state = M));
            }
  ...
  (t.html2canvas = function (i, o) {
    (o = o || {}),
      ...
      (o.removeContainer =
        'undefined' == typeof o.removeContainer ? !0 : o.removeContainer);
    ...
    (d.prototype.getMetrics = function (t, e) {
      return (
        this.data[t + '-' + e] === n && (this.data[t + '-' + e] = new l(t, e)),
        this.data[t + '-' + e]
      );
    }),
    ...
    (m.prototype.findImages = function (t) {
      var e = [];
      return (
        t.filter(y).map(w).forEach(this.addImage(e, this.loadImage), this),
    ...
    (T.prototype.css = function (t) {
      return (
        this.computedStyles || (this.computedStyles = this.computedStyle(null)),
    ...
    (T.prototype.prefixedCss = function (t) {
      ...
      return (
        r === n &&
          e.some(function (e) {
            return (
              (r = this.css(e + t.substr(0, 1).toUpperCase() + t.substr(1))),
              r !== n
            );
          }, this),
        r === n ? null : r
    ...
    (T.prototype.parseBounds = function () {
      return (
        this.bounds ||
        (this.bounds = this.hasTransform() ? M(this.node) : B(this.node))
      );
    }),
    ...
    (P.prototype.getPseudoElements = function (t) {
      ...
      if (t.node.nodeType === Node.ELEMENT_NODE) {
        ...
        n && (t.node.insertBefore(n[0].node, t.node.firstChild), e.push(n)),
    ...
    (P.prototype.getChildren = function (t) {
      return ce(
        [].filter.call(t.node.childNodes, Q).map(function (e) {
          var n = [
            e.nodeType === Node.TEXT_NODE ? new ye(e, t) : new T(e, t),
          ].filter(ae);
    ...
    (P.prototype.sortStackingContexts = function (t) {
      t.contexts.sort(ne), t.contexts.forEach(this.sortStackingContexts, this);
    }),
  ...
  (pe.prototype.renderImage = function (t, e, n, r) {
    ...
    (xe.prototype.clip = function (t, e, n) {
      this.ctx.save(), this.shape(t).clip(), e.call(n), this.ctx.restore();
    }),
